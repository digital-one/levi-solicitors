...
<div class="box-outer" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/our-history-header-bg.jpg');">
	<div class="box-content">
		<span class="vcenter-wrap">
			<span class="vcenter"><h1>OUR <strong>HISTORY</strong></h1><a href="#" class="button">Read more</a></span>
		</span>
	</div>
	</div>
